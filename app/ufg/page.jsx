...
export default function Ufg() {
  function generateBubble(title, description, videoSrc, learnMoreLink = null) {
    return (
      <FadeInWhenVisible className = "bubble" style={{gap : '20px', padding:'10px'}}>
        ...
        <p>{description}</p>
        <video
          style={{ marginTop: "20px",maxWidth: "min(800px, 100%)"}}
          controls = {true}
          autoPlay = {false}
          loop = {true}
          muted = {true}
  ...
  return (
    <div>
      ...
      <FadeInWhenVisible style = {{marginTop: '0px'}}>
        <ProjectSummary projectNumber={projects.UFG}>
          <p style = {{margin: '10px 10px 10px 10px'}}>
            ...
            It started as a <b>passion project</b> between me and two friends and after about two years of updates, the game exploded in popularity and in the span of a couple of months went from about 10k visits to over a million.
          </p>
      ...
      <FadeInWhenVisible className = "bubble">
        ...
        <div className={styles.credits}>
          ...
          <div className={styles.miniBubble}>
            ...
            <div className={about.iconContainer}>
              <a className={about.icon}  href="mailto:tyler.knepp@icloud.com"><img src={'/images/gmail_icon.webp'} alt="gmail" /></a>
      ...
      {generateBubble('Betty Update (May 2026) and Hiatus', 'During the 2025 to 2026 school year me and the other developers were extremely busy with school and other responsibilities so we decided to pause developement on UFG. After exam season we delivered the Betty update which added a new character and the games first skin. Now the games developement is on hiatus for the forseeable future depending on the situation.', '/videos/ufgBetty.mp4')}
